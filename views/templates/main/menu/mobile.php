            ...
            <ul class="">
                ...
                <li class="menu-mobile-item">
                    <a href="/basket/" class="menu-mobile-link menu-mobile-basket" rel="nofollow">
                        <span>
                            Корзина
                            <span class="menu-mobile-count <?= isset($this->cartCount) && $this->cartCount > 0 ? '' : 'empty' ?>">
                                <?= isset($this->cartCount) && $this->cartCount > 0 ? $this->cartCount : 0 ?>
                            </span>
                        </span>
                    </a>
            ...
            <div class="menu-mobile-social">
                <ul>
                    <li class="mobile-social-item">
                        <a href="<?= FACEBOOK ?>" class="mobile-social-link" target="_blank" rel="nofollow" title="Facebook">Facebook</a>
                    ...
                    <li class="mobile-social-item">
                        <a href="<?= VK ?>" class="mobile-social-link" target="_blank" rel="nofollow" title="Вконтакте">Вконтакте</a>
                    ...
                    <li class="mobile-social-item">
                        <a href="<?= TWITTER ?>" class="mobile-social-link" target="_blank" rel="nofollow" title="Twitter">
                    ...
                    <li class="mobile-social-item">
                        <a href="<?= INSTAGRAM ?>" class="mobile-social-link" target="_blank" rel="nofollow" title="Instagram">
                    ...
                    <li class="mobile-social-item">
                        <a href="<?= YOUTUBE ?>" class="mobile-social-link" target="_blank" rel="nofollow" title="YouTube">
                    ...
                    <li class="mobile-social-item">
                        <a href="<?= OK ?>" class="mobile-social-link" target="_blank" rel="nofollow" title="Одноклассники">
                    ...
                    <li class="mobile-social-item">
                        <a href="<?= GOOGLE ?>" class="mobile-social-link" target="_blank" rel="nofollow" title="Google Plus">
                    ...
                    <li class="mobile-social-item">
                        <a href="<?= MAIL ?>" class="mobile-social-link" target="_blank" rel="nofollow" title="Mail.ru">
