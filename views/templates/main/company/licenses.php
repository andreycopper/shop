    ...
    <div class="main-section">
        ...
        <div class="license-item">
            <div class="license-image">
                <a href=""><img src="/uploads/company/license/1.jpg" alt=""></a>
            </div>
            <div class="license-desc">
                <div class="license-title">Сертификат соответствия</div>
                <div class="license-text">
                    Сертификат соответствия – документ, подтверждающий соответствие продукции требованиям качества и безопасности, установленными
                    для нее действующими стандартами и правилами (ГОСТ, ГОСТ Р, ГОСТ Р МЭК, ТУ, Технический регламент и пр.).
                </div>
            </div>
        </div>
        ...
        <div class="license-item">
            ...
            <div class="license-desc">
                <div class="license-title">Свидетельство о государственной регистрации</div>
                <div class="license-text">
                    Свидетельство о государственной регистрации или письмо о соответствии продукции Единым санитарно-эпидемиологическим и гигиеническим
                    требованиям – документ, подтверждающий, что продукция соответствуют установленным Единым гигиеническим нормам.
                </div>
            </div>
        </div>
        ...
        <div class="license-item">
            ...
            <div class="license-desc">
                <div class="license-title">Сертификат пожарной безопасности</div>
                <div class="license-text">
        ...
        <div class="license-item">
            ...
            <div class="license-desc">
                <div class="license-title">Лицензия на оказание услуг </div>
                <div class="license-text">
                    Сертификат соответствия Госстроя, выдается на продукцию, используемую в строительстве, и подтверждающий, что продукция соответствует
                    требованиям основных нормативно-технических документов, установленных для данной продукции при сертификации продукции в строительстве.
                </div>
            </div>
        </div>
