...
{
    protected static $db_table = 'user_register_requests';
    ...
    public static function create(int $id)
    {
        ...
        if (false === $request->save()) {
            Logger::getInstance()->error(new DbException('Ошибка записи запроса на регистрацию в БД пользователя с id = ' . $id));
            return false;
        }
